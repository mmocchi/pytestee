...
class TestAssertDensityChecker:
    ...
    def test_check_no_assertions(self) -> None:
    ...
    def test_check_too_many_assertions(self) -> None:
    ...
    def test_check_good_assertion_count(self) -> None:
    ...
    def test_count_effective_lines(self) -> None:
    ...
    def test_analyze_test_complexity(self) -> None:
