...
class TestASTParser:
    ...
    def test_parse_file_with_valid_test_file(self):
    ...
    def test_is_test_function_detection(self):
...
'''
    ...
    def test_count_assert_statements(self):
    ...
    def test_get_function_lines(self):
