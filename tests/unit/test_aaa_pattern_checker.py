...
class TestAAAPatternChecker:
    ...
    def test_check_good_aaa_pattern_with_comments(self) -> None:
    ...
    def test_check_structural_aaa_pattern(self) -> None:
    ...
    def test_check_no_clear_pattern(self) -> None:
    ...
    def test_check_patterns_in_comments(self) -> None:
    ...
    def test_looks_like_aaa_structure(self) -> None:
